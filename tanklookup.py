...
tankst5 = {
    ...
    "excelsior": "excelsior",
    "kv-1": "kv-1", "kv1": "kv-1",
    "kv-1sh": "kv-1sh", "kv-1 shielded": "kv-1sh",
...
tankst7 = {
    ...
    "kv-122": "kv-122",
    "kv-3": "kv-3",
    "m-ii-y": "m-ii-y", "miiy": "m-ii-y", "m2y": "m-ii-y", "m-2-y": "m-ii-y",
    "o-ni": "o-ni", "o ni": "o-ni",
...
tankst8 = {
    ...
    "astron rex 105 mm": "astron-rex", "astron rex": "astron-rex",
    ...
    "kv-5": "kv-5",
    "lowe": "lowe",
    "m-iii-y": "m-iii-y", "miiiy": "m-iii-y", "m3y": "m-iii-y", "m-3-y": "m-iii-y",
...
tankst9 = {
    ...
    "m-vi-y": "m-vi-y", "mviy": "m-vi-y", "m6y": "m-vi-y", "m-6-y": "m-vi-y",
    "m103": "m103",
    "mauschen": "mauschen",
...
tankst10 = {
    ...
    "fv4202 p": "fv4202", "fv4202 10": "fv4202",
    "k-91": "k-91",
    "leopard 1": "leopard-1",
    ...
    "is-7": "is-7",
    "kranvagn": "kranvagn",
    "m-v-y": "m-v-y", "mvy": "m-v-y", "m5y": "m-v-y", "m-5-y": "m-v-y",
    "maus": "maus",
...
versions = {"9.17": "0917", "9.17.1": "09171", "9.18": "0918", "9.19": "0919", "9.19.1": "09191", "9.20": "0920", "9.20.1": "09201",
            ...
            "1.12.1": "11210", "1.13": "11300", "1.14": "11400", "1.14.1": "11410", "1.15": "11500", "1.15.0.3415": "11503"
            }
...
def lookup_mark_heap(tank, region, dictionary, update=False):
    ...
    if result:
        try:
            ...
            print(e)
            print(f'DEBUG 4: error on {region} dictionary for {tank}')
    ...
    if result:
        try:
            ...
            matched_ids = []
            missed_ids = []
            for tankid in result:
                id = next((tier[tankid] for tier in allidsmarks if tankid in tier), None)
                if id is not None and id in dictionary[region]:
                    matched_ids.append(tankid + dictionary[region][id])
                else:
                    missed_ids.append(tankid)
            if len(matched_ids) > 3:
                return 'more than 3 tanks found; refine search'
            elif 3 >= len(matched_ids) > 1:
                answer = str(len(matched_ids)) + ' tanks found: '
                for tankid in matched_ids:
                    answer += '\n' + tankid
                return answer
